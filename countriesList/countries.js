const countries = [
    ...
    { countryCode: 'AE', label: 'United Arab Emirates', dialCode: '971' },
    { countryCode: 'AF', label: 'Afghanistan', dialCode: '93' },
    { countryCode: 'AG', label: 'Antigua and Barbuda', dialCode: '1-268' },
    ...
    { countryCode: 'AU', label: 'Australia', dialCode: '61', suggested: true },
    ...
    { countryCode: 'BA', label: 'Bosnia and Herzegovina', dialCode: '387' },
    ...
    { countryCode: 'CA', label: 'Canada', dialCode: '1', suggested: true },
    { countryCode: 'CC', label: 'Cocos (Keeling) Islands', dialCode: '61' },
    { countryCode: 'CD', label: 'Congo, Democratic Republic of the', dialCode: '243' },
    { countryCode: 'CF', label: 'Central African Republic', dialCode: '236' },
    { countryCode: 'CG', label: 'Congo, Republic of the', dialCode: '242' },
    ...
    { countryCode: 'DE', label: 'Germany', dialCode: '49', suggested: true },
    ...
    { countryCode: 'DO', label: 'Dominican Republic', dialCode: '1-809' },
    ...
    { countryCode: 'FK', label: 'Falkland Islands (Malvinas)', dialCode: '500' },
    { countryCode: 'FM', label: 'Micronesia, Federated States of', dialCode: '691' },
    { countryCode: 'FO', label: 'Faroe Islands', dialCode: '298' },
    { countryCode: 'FR', label: 'France', dialCode: '33', suggested: true },
    ...
    { countryCode: 'GS', label: 'South Georgia and the South Sandwich Islands', dialCode: '500' },
    ...
    { countryCode: 'HM', label: 'Heard Island and McDonald Islands', dialCode: '672' },
    ...
    { countryCode: 'IO', label: 'British Indian Ocean Territory', dialCode: '246' },
    { countryCode: 'IQ', label: 'Iraq', dialCode: '964' },
    { countryCode: 'IR', label: 'Iran, Islamic Republic of', dialCode: '98' },
    ...
    { countryCode: 'JP', label: 'Japan', dialCode: '81', suggested: true },
    ...
    { countryCode: 'KN', label: 'Saint Kitts and Nevis', dialCode: '1-869' },
    { countryCode: 'KP', label: "Korea, Democratic People's Republic of", dialCode: '850' },
    ...
    { countryCode: 'LA', label: "Lao People's Democratic Republic", dialCode: '856' },
    ...
    { countryCode: 'MD', label: 'Moldova, Republic of', dialCode: '373' },
    { countryCode: 'ME', label: 'Montenegro', dialCode: '382' },
    { countryCode: 'MF', label: 'Saint Martin (French part)', dialCode: '590' },
    { countryCode: 'MG', label: 'Madagascar', dialCode: '261' },
    { countryCode: 'MH', label: 'Marshall Islands', dialCode: '692' },
    { countryCode: 'MK', label: 'Macedonia, the Former Yugoslav Republic of', dialCode: '389' },
    ...
    { countryCode: 'MP', label: 'Northern Mariana Islands', dialCode: '1-670' },
    ...
    { countryCode: 'PM', label: 'Saint Pierre and Miquelon', dialCode: '508' },
    { countryCode: 'PN', label: 'Pitcairn', dialCode: '870' },
    { countryCode: 'PR', label: 'Puerto Rico', dialCode: '1' },
    { countryCode: 'PS', label: 'Palestine, State of', dialCode: '970' },
    ...
    { countryCode: 'SJ', label: 'Svalbard and Jan Mayen', dialCode: '47' },
    ...
    { countryCode: 'ST', label: 'Sao Tome and Principe', dialCode: '239' },
    { countryCode: 'SV', label: 'El Salvador', dialCode: '503' },
    { countryCode: 'SX', label: 'Sint Maarten (Dutch part)', dialCode: '1-721' },
    { countryCode: 'SY', label: 'Syrian Arab Republic', dialCode: '963' },
    { countryCode: 'SZ', label: 'Swaziland', dialCode: '268' },
    { countryCode: 'TC', label: 'Turks and Caicos Islands', dialCode: '1-649' },
    { countryCode: 'TD', label: 'Chad', dialCode: '235' },
    { countryCode: 'TF', label: 'French Southern Territories', dialCode: '262' },
    ...
    { countryCode: 'TT', label: 'Trinidad and Tobago', dialCode: '1-868' },
    { countryCode: 'TV', label: 'Tuvalu', dialCode: '688' },
    { countryCode: 'TW', label: 'Taiwan, Province of China', dialCode: '886' },
    { countryCode: 'TZ', label: 'United Republic of Tanzania', dialCode: '255' },
    { countryCode: 'UA', label: 'Ukraine', dialCode: '380' },
    { countryCode: 'UG', label: 'Uganda', dialCode: '256' },
    { countryCode: 'US', label: 'United States', dialCode: '1', suggested: true },
    { countryCode: 'UY', label: 'Uruguay', dialCode: '598' },
    { countryCode: 'UZ', label: 'Uzbekistan', dialCode: '998' },
    { countryCode: 'VA', label: 'Holy See (Vatican City State)', dialCode: '379' },
    { countryCode: 'VC', label: 'Saint Vincent and the Grenadines', dialCode: '1-784' },
    { countryCode: 'VE', label: 'Venezuela', dialCode: '58' },
    { countryCode: 'VG', label: 'British Virgin Islands', dialCode: '1-284' },
    { countryCode: 'VI', label: 'US Virgin Islands', dialCode: '1-340' },
